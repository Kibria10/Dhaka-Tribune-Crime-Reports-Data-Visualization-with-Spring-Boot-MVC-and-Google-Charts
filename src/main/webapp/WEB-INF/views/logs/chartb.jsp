...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$.ajax({
			...
			url : '${pageContext.request.contextPath}/taskb/findall',
		...
		function drawChart(result) {
			...
			var linechart_options = {
				title : 'Dhaka Tribune: Murder Cases Events V/S Reports Submitted_Line Graph',
				width : 1920,
				height : 900,
				legend :'none'
			};
...
<div>
<center><h2><a href="http://localhost:8888/murder/histogram"> Convert Into Histogram</a></h2></center>
</div>
